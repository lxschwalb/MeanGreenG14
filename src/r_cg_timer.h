...
#define _001F_TMRJ_TRJ0_VALUE                   (0x001FU)
/* TMRD register A0 (TRDGRA0) */
#define _0003_TMRD_TRDGRA0_VALUE                (0x0003U)
/* TMRD register B0 (TRDGRB0) */
#define _0000_TMRD_TRDGRB0_VALUE                (0x0000U)
/* TMRD register C0 (TRDGRC0) */
#define _0001_TMRD_TRDGRC0_VALUE                (0x0001U)
/* TMRD register D0 (TRDGRD0) */
#define _0003_TMRD_TRDGRD0_VALUE                (0x0003U)
/* TMRD register A1 (TRDGRA1) */
#define _000F_TMRD_TRDGRA1_VALUE                (0x000FU)
/* TMRD register B1 (TRDGRB1) */
#define _000D_TMRD_TRDGRB1_VALUE                (0x000DU)
/* TMRD register C1 (TRDGRC1) */
#define _0007_TMRD_TRDGRC1_VALUE                (0x0007U)
/* TMRD register D1 (TRDGRD1) */
#define _0002_TMRD_TRDGRD1_VALUE                (0x0002U)
/* Timer RG General Register A (TRGGRA)*/
#define _0007_TMRG0_TRGGRA_VALUE                (0x0007U)
/* Timer RG General Register B (TRGGRB)*/
#define _0003_TMRG0_TRGGRB_VALUE                (0x0003U)
